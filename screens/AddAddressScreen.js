import { Text, TouchableOpacity, View, Dimensions, StyleSheet, TextInput, Image } from 'react-native';
    ...
    return (
        <View >
            <View className="relative">
                ...
                <MapView className="w-screen h-screen min-h-full" initialRegion={initialPosition} ref={mapRef} >
                ...
                <TouchableOpacity style={styles.confirmButton}
                    onPress={() => { navigation.navigate("UserProfile"); console.log(details.formatted_address) }}>
                    <Text className="text-white self-center text-lg">Confirm</Text>

                </TouchableOpacity>
            </View>
            {/* <Text>HomeScreen</Text>
            <TouchableOpacity className="bg-gray-200 px-4 py-2 m-4" onPress={() => navigation.navigate('Login')}>
                <Text>go back</Text>
            </TouchableOpacity> */}
        </View>
    )
